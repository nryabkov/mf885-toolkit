#!/usr/bin/env python3
"""Build the pinned dev.15 source in an isolated offline Python process."""
import argparse
import json
import sys
...
def main(argv=None):
    ...
    sys.path[:0] = [str(ROOT / 'firmware/community-0.4.7-dev.15'), str(ROOT / 'tools')]
    ...
    try:
        ...
        report = candidate.comparator.publish_candidate(
            ...
            schema='mf885-047d15-public-build/v1',
            verification_schema='mf885-047d15-public-verify/v1',
            ...
            qualification={
                ...
                'reference_status': 'one-device dev15 boot/assets/recovery, two AT diagnostic commands and one attributed text USSD reply; other commands/carriers unqualified',
                'reference_date': '2026-09-09',
                'qualification_document': 'docs/AT_USSD_047D15_RU.md',
        ...
        print('dev.15 offline build failed: ' + str(exc), file=sys.stderr)
        return 2
