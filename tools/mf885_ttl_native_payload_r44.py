...
SOURCE = ROOT / "firmware/community-r4.4/native/ttl_forward_fixed64_armv5.ll"
SOURCE_BYTES = 3084
SOURCE_SHA256 = "6bcd059032cc30c8ff780d9d7677b8744ab0ba780054f4e9b5df4c9e0571fc7b"
FUNCTION = "ttl_forward_fixed64_armv5"
TARGET_TTL = 64
...
TARGET = {"target_triple": b"thumbv5te-none-eabi", "target_cpu": b"arm926ej-s",
          "target_features": b"+thumb-mode,-thumb2,-neon,-vfp2"}
ENTRY_STUB = bytes.fromhex("280031002200ffe7")
BODY_BYTES = 148
BODY_CODE_BYTES = 140
BODY_SHA256 = "bdafeef06d18f398142937202a46e6ef9654cf16797ee0dd24383ff868a16eb9"
FORWARD_BYTES = 156
FORWARD_CODE_BYTES = 148
FORWARD_SHA256 = "c04dc80c7f37309d1e9304257211ba84cf2ab51fbe55d7e9e79e62bb49750c6d"
...
class TtlR44PayloadError(RuntimeError):
    pass
...
def require(conditions: list[dict[str, Any]], context: str) -> None:
    ...
    if failed:
        raise TtlR44PayloadError(context + ": " + ", ".join(failed))
...
def compile_forward() -> tuple[bytes, list[dict[str, Any]]]:
    ...
    require(conditions, "R4.4 LLVM source rejected")
    ...
    require(conditions, "R4.4 emitted machine code rejected")
    ...
    require(conditions, "R4.4 complete helper rejected")
...
def build_payload(oslo: bytes) -> tuple[bytes, dict[str, Any]]:
    ...
    require(source_report["conditions"], "R4.4 stock OSLO rejected")
    ...
    require(preserved, "R4.4 component isolation rejected")
    return result, {
        "schema": "mf885-community-r44-fixed64-forward-native-payload/v1", "status": "GREEN",
...
def verify_payload(source: bytes, candidate: bytes) -> dict[str, Any]:
    ...
    return {"schema": "mf885-community-r44-fixed64-forward-native-verification/v1", "status": "GREEN" if all(c["passed"] for c in conditions) else "REJECTED", "conditions": conditions, "build": built}
...
def main(argv: list[str] | None = None) -> int:
    ...
    except (OSError, ValueError, TtlR44PayloadError, thumb.NativeBuildError) as exc:
