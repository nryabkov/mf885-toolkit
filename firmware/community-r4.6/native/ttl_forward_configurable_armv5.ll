...
; Read one RAM configuration byte per packet: zero is Off, otherwise target1..255.
...
entry:
  ...
  %target8 = load volatile i8, ptr %statep, align 1
  %target32 = zext i8 %target8 to i32
