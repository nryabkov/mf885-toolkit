...
; Phase4 readback: r46:GGGGGGGG:TT, hexadecimal generation and sampled TTL.
; Increment one aligned RAM counter, publish a synchronous stack string copy.
; A client must observe generation advancement; HTTP200 alone is insufficient.
...
snapshot:
  ...
  %statep = inttoptr i32 100668576 to ptr
  %counterp = inttoptr i32 100668580 to ptr
  %state8 = load volatile i8, ptr %statep, align 1
  %oldgen = load volatile i32, ptr %counterp, align 4
  %generation = add i32 %oldgen, 1
  store volatile i32 %generation, ptr %counterp, align 4
  store i32 976630898, ptr %buffer, align 4
