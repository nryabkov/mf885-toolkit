...
publish.off:
  %off.value = inttoptr i32 100668496 to ptr
  br label %publish
...
publish:
  %value = phi ptr [ %off.value, %publish.off ], [ %digits, %publish.numeric ]
  %setter = inttoptr i32 104887259 to ptr
  %model = inttoptr i32 100668500 to ptr
  %field = inttoptr i32 100668520 to ptr
  %unused = call i32 %setter(ptr %model, i32 0, ptr %field, ptr %value)
  br label %done
