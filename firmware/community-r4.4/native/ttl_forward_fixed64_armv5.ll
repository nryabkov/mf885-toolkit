...
; Fixed outgoing TTL=64 for eligible forwarded IPv4 packets.
; No configuration/state/diagnostic access. Output ABI is inherited unchanged.
define i32 @ttl_forward_fixed64_armv5(ptr %iphdr, ptr %pbuf, ptr %outnetif) #0 {
entry:
...
attributes #0 = { nounwind minsize noinline "frame-pointer"="none" "target-cpu"="arm926ej-s" "target-features"="+thumb-mode,-thumb2,-neon,-vfp2" }
