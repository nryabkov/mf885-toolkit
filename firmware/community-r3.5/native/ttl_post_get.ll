...
; Community R3.5 publishes exactly one field on the same Duster model.
; This deliberately mirrors stock one-setter post_get callbacks and avoids
; both R3.1's three-field publisher and R3.3's cross-model bridge.
