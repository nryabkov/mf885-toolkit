...
; Fixed TTL=64 for eligible forwarded IPv4 packets at every header alignment.
...
define i32 @ttl_forward_fixed64_bytes_armv5(ptr %iphdr, ptr %pbuf, ptr %outnetif) #0 {
entry:
...
checksum:
  ...
  store volatile i8 64, ptr %wordp, align 1
  br label %send
