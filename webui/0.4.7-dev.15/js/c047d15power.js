/* MF885 Community 0.4.7-dev.15: explicit one-shot stock power operations. */
(function(w){
  'use strict';
  var app=w.MF885Community047Dev15,b=app.powerBridge,busy=false,consumed=false,appNonce=2;
  ...
  w.MF885Community047Dev15Power={apply:apply,syncControls:syncControls};syncControls();
})(window);
