...
(function(w){
  'use strict';
  var bridge=w.MF885Community047Dev18.consoleBridge,client=null,busy=false,epoch=0,activeEpoch=0,lastQueue=null;
  var help={
  ...
  async function run(operation,kind){
    ...
    var token=bridge.begin('console',prefix+'Status');if(!token)return null;
    ...
    finally{busy=false;bridge.end('console',token);syncControls()}
  }
  ...
  w.MF885Community047Dev18Console={run:run,reset:reset,syncControls:syncControls,wire:wire};syncControls();
})(window);
