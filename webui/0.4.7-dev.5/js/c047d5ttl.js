/* Community 0.4.7-dev.5: explicit reads and one serialized TTL write. */
(function (w) {
  'use strict';
  var core = w.MF885Community047Dev5, bridge = core && core.ttlBridge;
  var capabilityText = '{"schema":"mf885-ttl-editor/v1","communityVersion":"0.4.7-dev.5","vendorBase":"2.5.94","nativeApi":"r47-revision24-ttl8","settings":["64","off"],"persistence":"ram","bootTtl":64}\n';
  ...
  function capability(owner, epoch) {
    return Promise.resolve().then(function () {
      check(epoch);
      if (core.version !== '0.4.7-dev.5') throw problem('E_TTL_CORE_VERSION');
  ...
  w.MF885Community047Dev5TTL = {version: '0.4.7-dev.5', state: state, strictState: strictState, nextRevision: nextRevision, read: read, setValue: setValue, reset: reset, syncControls: syncControls, bind: bind};
