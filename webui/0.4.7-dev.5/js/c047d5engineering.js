/* Community 0.4.7-dev.5: explicit Engineering control, serialized with other router actions. */
(function(w){
  'use strict';
  var core=w.MF885Community047Dev5, bridge=core&&core.engineeringBridge;
  ...
  w.MF885Community047Dev5Engineering={version:'0.4.7-dev.5',state:state,parseState:parseState,read:read,apply:apply,reset:reset,syncControls:syncControls,bind:bind};
