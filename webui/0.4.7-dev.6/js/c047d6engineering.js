/* Community 0.4.7-dev.6: explicit Engineering control, serialized with other router actions. */
(function(w){
  'use strict';
  var core=w.MF885Community047Dev6, bridge=core&&core.engineeringBridge;
  ...
  w.MF885Community047Dev6Engineering={version:'0.4.7-dev.6',state:state,parseState:parseState,read:read,apply:apply,reset:reset,syncControls:syncControls,bind:bind};
